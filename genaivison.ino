...
// Web Page with Chat Interface (no brightness control)
...
void setup() {
  ...
  // Set default brightness (0 is neutral, optimal for most conditions)
  sensor_t * s = esp_camera_sensor_get();
  if (s != NULL) {
    s->set_brightness(s, 0); // Range: -64 to 64, 0 is default
